...
- 拡散機能（共有カード等）は、本番環境では Feature Flag によりデフォルトで **完全非表示** とする

## 8. 将来機能と Feature Flag

- 「拡散機能完全仕様書」「拡散設計ワイヤーフレーム」に記載の機能は、`utils/featureFlags.ts` で一括管理する
- 本番環境での公開は、拡散UI等の公開条件を満たすまで **禁止**
- すべての新機能は Feature Flag 下で開発し、監査テストをクリアしてからメインブランチへ統合する
...
| 2026-03-05 | v1.1 | 拡散機能・将来機能の封印条項を追加 |
